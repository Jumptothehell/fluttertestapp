...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Giverdetail_2(title: 'Project'),
    );
  }
}

class Giverdetail_2 extends StatefulWidget {
  const Giverdetail_2({super.key, required this.title});

  final String title;

  @override
  State<Giverdetail_2> createState() => _Giverdetail_2();
}

class _Giverdetail_2 extends State<Giverdetail_2> {
  int _counter = 0;
